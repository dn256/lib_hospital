...
export const IHC_MARKER_ATLAS: IhcMarkerProfile[] = [
  {
    ...
    name: 'ALK (phổi)',
    gene: 'ALK',
    aliases: ['ALK', 'ALK (lung)', 'Anaplastic lymphoma kinase', 'Protein ALK', 'CD246'],
    ...
    summaryVi: 'HMMD ALK có thể được dùng như xét nghiệm thay thế để phát hiện biểu hiện protein liên quan tái sắp xếp ALK trong ung thư phổi không tế bào nhỏ khi sử dụng hệ thống xét nghiệm đã được thẩm định. Không suy diễn trạng thái ALK chỉ từ bắt màu nền hoặc biểu hiện ở mô bình thường.',
    positiveVi: 'Với xét nghiệm VENTANA ALK (D5F3) CDx trong ung thư phổi không tế bào nhỏ: tín hiệu bào tương dạng hạt mạnh ở tế bào u, ở bất kỳ tỷ lệ nào, được xếp dương tính theo thuật toán của xét nghiệm. Báo cáo NordiQC còn đánh giá độ nhạy kỹ thuật bằng ung thư biểu mô tuyến phổi có tái sắp xếp ALK với mức bắt màu bào tương dạng hạt từ yếu-vừa đến mạnh.',
    negativeVi: 'Với xét nghiệm D5F3 CDx: không có tín hiệu bào tương dạng hạt mạnh trong tế bào u được xếp âm tính. Kết quả âm tính không đáng tin cậy khi chứng mô không đạt, mô u quá ít, nền bất thường hoặc xét nghiệm chưa được xác nhận hiệu năng; khi kết quả không phù hợp hình thái hoặc bối cảnh lâm sàng, cần cân nhắc xét nghiệm phân tử theo quy trình của cơ sở.',
    ...
    indicationsVi: [
      'Đánh giá trạng thái ALK ở ung thư phổi không tế bào nhỏ khi cần định hướng điều trị nhắm trúng đích, theo hướng dẫn và hệ thống xét nghiệm đã được phê duyệt hoặc thẩm định tại cơ sở.',
    ...
    pitfallsVi: [
      ...
      'Clone ALK1 có thể không đủ nhạy cho ung thư biểu mô tuyến phổi có EML4::ALK; NordiQC 2025 ghi nhận OTI1A4, 5A4 và D5F3 có hiệu năng khác nhau tùy hệ thống và quy trình nhuộm.',
      'Không dùng biểu hiện ALK ở mô thần kinh bình thường để minh họa hoặc chấm kết quả ALK trong ung thư phổi; phải đối chiếu hình ảnh của đúng clone và hệ thống xét nghiệm đã thẩm định.',
    ],
    contexts: [
      {
        organ: 'Phổi',
        tissue: 'Ung thư phổi không tế bào nhỏ / ung thư biểu mô tuyến phổi',
        pattern: 'D5F3 CDx: bào tương dạng hạt mạnh trong tế bào u; không yêu cầu tỷ lệ tối thiểu khi có tín hiệu đặc hiệu.',
        ...
        limitation: 'Thuật toán phụ thuộc hệ thống xét nghiệm. Không áp dụng ngưỡng này cho clone hoặc nền tảng chưa được thẩm định; kết quả bất tương hợp cần được xử lý theo quy trình xác nhận của phòng xét nghiệm.',
      },
      {
        ...
        limitation: 'Biểu mô hoặc lympho bào bắt màu bất thường là dấu hiệu xét nghiệm không đạt, không phải biểu hiện ALK có ý nghĩa chẩn đoán.',
      },
    ],
    sources: [
      {
