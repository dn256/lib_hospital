...
<style scoped>
.atlas-page { min-height: 100%; padding-bottom: 34px; overflow: hidden; background: transparent; }
...
.state-panel { min-height: 420px; display: grid; place-content: center; justify-items: center; gap: 14px; color: #385568; background: rgba(238,243,245,.97); }.error-state { color: #a13b3f; }
...
.atlas-workspace { max-width: 1740px; margin: 0 auto; background: rgba(238,243,245,.97); box-shadow: 0 22px 55px rgba(2,18,30,.2); }
