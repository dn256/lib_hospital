          ...
          <div class="morphology-panel">
            ...
            <div class="search-row">
              <label class="search-box">
                ...
                <input v-model="morphologyQuery" type="search" placeholder="Tên Việt, English, BCC, SCC, HCC, PTC, 8140/3...">
...
@media (max-width: 1100px) { .icdo-hero { grid-template-columns: 1fr; }.hero-stats { max-width: 660px; }.lookup-grid { grid-template-columns: 1fr; }.selection-grid { grid-template-columns: 1fr 1fr; }.combined-cell { grid-column: 1 / -1; min-height: 98px; }.selection-cell:nth-child(2) { border-right: 0; }.source-panel { grid-template-columns: 1fr; } }
